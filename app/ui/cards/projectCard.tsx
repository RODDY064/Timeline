...
export default function ProjectCard({ data }: { data: any }) {
  return (
    <>
      <div className="md:w-[16.4rem] hover:border-light_green hover:bg-cream_green/10  max-sm:place-self-center  flex-none w-[90%] h-[14rem] md:h-[12rem]  bg-white  rounded-[35px]  border border-black/10 p-4 px-5 cursor-pointer">
